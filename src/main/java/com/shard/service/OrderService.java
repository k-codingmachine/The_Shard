...
public interface OrderService{
   ...
   public int couponCount(String email); // 회원의 쿠폰 갯수
...
//   public int calculateTotalPrice(List<Integer> sales, List<Integer> cnt);
   //주문완료
   public void orderComplete(OrdersVO ovo, DetailOrderVO dvo, int cartNum, 
                     List<Integer> itemNum,int orderId, int usePoint, String email, int issueNum);
   //주문취소
