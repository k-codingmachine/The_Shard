...
public interface OrdersMapper {
	...
	//detailOrder 생성
	public void detailOrderInsert(DetailOrderVO dvo, int result);
...
//	public void ordersDelete(int orderId);
	//결제완료(주문완료)
	public void cartDelete(int cartNum, List<Integer> itemNum);
	public void useCouponIssuanceUpdate(int orderId, int issueNum);
	public void customerPointUpdate(int usePoint, String email);
	public void ordersUpdate(int usePoint, int orderId);
