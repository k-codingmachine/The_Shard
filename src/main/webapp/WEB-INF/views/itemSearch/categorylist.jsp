	...
	<ul class="pagination justify-content-center">
		<c:if test="${pageMaker.prev}">
			<li class="page-item"><a class="page-link"
				href="/itemSearch/list/category/${categoryNum}?pageNum=${pageMaker.startPage - 1}">Previous</a></li>
		</c:if>
		...
		<c:forEach var="num" begin="${pageMaker.startPage}"
			...
			<li class="page-item ${pageMaker.pageNum == num ? 'active' : ''}">
				<a class="page-link"
				href="/itemSearch/list/category/${categoryNum}?pageNum=${num}">${num}</a>
		...
		<c:if test="${pageMaker.next}">
			<li class="page-item"><a class="page-link"
				href="/itemSearch/list/category/${categoryNum}?pageNum=${pageMaker.endPage + 1}">Next</a></li>
		</c:if>
	</ul>
</div>
